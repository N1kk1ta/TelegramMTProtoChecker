...
После успешной сборки GitHub Actions автоматически создаёт/обновляет релиз **v5.13** и прикладывает к нему `TelegramProxyChecker.exe`.
